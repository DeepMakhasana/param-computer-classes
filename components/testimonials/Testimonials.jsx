                ...
                >
                        ...
                        <div className={styles.testimonialsContent}>
                            ...
                            <div className={styles.infoContent}>
                                <p>"Param Computer Classes is a right way to success in computer field. <br />
                                    ...
                                    They solve our all problem regarding this course."</p>
                    ...
                    <SwiperSlide>
                        <div className={styles.testimonialsContent}>
                            ...
                            <div className={styles.infoContent}>
                                <p>"I really appreciated the hands-on approach in the computer class. The practical exercises and real-world examples helped me understand the concepts better and apply them in a meaningful way."</p>
                                <h5>Jhanvi patel</h5>
                            </div>
                        </div>
                    </SwiperSlide>
